#define NGX_CONFIGURE " --prefix=/usr/local/nginxworking --with-cc-opt='-g -O0' --add-module=/mnt/hgfs/mycode/nginx-1.10.2-working/nginx-snmp-module/"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/local/nginxworking/"
#endif
