...
#define BZHY_ADMIN_SESSION_ID "bzhy_sessionid"
...
typedef enum {
    NGX_HTTP_BZHY_ADMIN_VAR_METHOD_GET = 0,
    NGX_HTTP_BZHY_ADMIN_VAR_METHOD_POST,
    NGX_HTTP_BZHY_ADMIN_VAR_METHOD_COOKIE,
    NGX_HTTP_BZHY_ADMIN_VAR_METHOD_SESSION,
    NGX_HTTP_BZHY_ADMIN_VAR_METHOD_ALL
}bzhy_admin_http_variable_method_e;
